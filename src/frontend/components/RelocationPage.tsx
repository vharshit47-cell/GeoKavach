...
export function RelocationPage() {
  ...
  const download = () => {
    ...
    const text = ["SURAKSHASETU — RELOCATION RECOMMENDATION", "Demo Dataset · provisional; not an evacuation order", "Habitation: " + origin.name, "Population: " + origin.population, "Selected safe site: " + selected.site.name, "Straight-line distance: " + selected.distance.toFixed(1) + " km", "Capacity available: " + selected.site.remaining_capacity, "Capacity after proposal: " + (selected.site.remaining_capacity - origin.population), "Risk: " + origin.risk_score + "/100", "Priority: " + origin.priority_category, "Reason: " + reason].join("\n");
